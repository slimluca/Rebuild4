...
export const categoryInfoSections: Record<string, InfoSectionContent> = {
  ...
  "modelle-private": {
    ...
    links: [
      { href: "/modelle-online-ora/", label: "Modelle online ora" },
